...
"""
        ...
        # BOLT OPTIMIZATION: Run synchronous Gemini call in thread pool to avoid blocking event loop
        response = await asyncio.to_thread(self.gemini_service.extract_json_from_markdown, prompt, schema)
        return response
