...
# Cache for user profiles: 1000 users max, 60 seconds TTL
    ...
    try:
        ...
        if current_user:
            ...
            if supabase:
                ...
                # Invalidate cache for this user to reflect new credit balance immediately
...
async def payment_success(
    ...
    try:
        ...
        # Invalidate cache for this user to reflect new credits immediately
        if user_id in user_cache:
