...
latex_content = Path("PPT_samples/yellow.md").read_text(encoding='utf-8')

print("Starting compilation check for yellow.md (FIXED VERSION)...")

tmpdir_path = Path("temp_debug_yellow")
